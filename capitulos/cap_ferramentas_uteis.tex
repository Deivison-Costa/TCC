...
\begin{figure}[!htb] \centering
  ...
  \begin{varwidth}{\linewidth}
    ...
    \fonte{Elaborado pelo autor com Python (Matplotlib e pandas).}
  \end{varwidth}
\end{figure}
...
O sensor BMP280 registrou valores de pressão atmosférica entre 950 hPa e 1020 hPa, refletindo as variações típicas da região de Bambuí. A evolução da pressão ao longo do tempo é mostrada na Figura \ref{fig:leituras-pres}.
...
Para comparar os dados coletados pelo sistema \textit{IrrigaSync} em 16/10/2024 foram utilizadas informações do \textcite{inmet2024} para a cidade de Bambuí, Minas Gerais. A Tabela \ref{tab:comparacao-dados} apresenta uma comparação entre as variáveis climáticas registradas pelo \textit{IrrigaSync} e os dados disponíveis do INMET para a mesma data e periódo horário.
...
No caso específico para essa época do ano, em outubro, geralmente há uma variação significativa dependendo da fase fenológica da planta e das condições climáticas da região. 
