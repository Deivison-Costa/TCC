...
Este trabalho tem como objetivo geral desenvolver um sistema de monitoramento em tempo real para o cultivo agrícola. A proposta é utilizar tecnologias modernas e o método científico da evapotranspiração de cultura (ETc), visando aumentar a eficácia do monitoramento da cultura e de suas necessidades hídricas.
