...
\begin{table}[!htb]
    ...
    \begin{tabularx}{\textwidth}{|X|X|X|} \hline
        ...
        Presente pesquisa & \textit{Node.js}, \textit{React}, \textit{Nest.js}, \textit{Shadcn/ui}, \textit{Tailwind CSS}, \textit{MQTT} e \textit{MySQL}. & Alto consumo de memória em aplicações de alta carga e maior curva de aprendizado inicial para integração do MQTT. \\ \hline
    \end{tabularx}
