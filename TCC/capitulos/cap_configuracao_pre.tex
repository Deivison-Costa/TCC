...
A ETo é determinada por fatores como radiação líquida ($R_n$), calor do solo ($G$), déficit de pressão de vapor ($\Delta$), constante psicrométrica ($\gamma$), temperatura média do ar ($T$), velocidade do vento a 2 metros de altura ($u2$), pressão de vapor do ar saturado ($e_s$) e pressão de vapor do ar ($e_a$).
