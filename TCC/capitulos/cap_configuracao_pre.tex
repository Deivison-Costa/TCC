...
\section{Evapotranspiração de referência}
...
\section{Evapotranspiração de cultura}
...
Ela é calculada como o produto da ETo e um determinado $Kc$ para cada cultura, como proposto por \textcite{bernardo_irrigacao2008}:
