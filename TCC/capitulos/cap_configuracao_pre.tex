...
Uma das áreas de aplicação do sensoriamento remoto na atualidade é a agricultura. Estudos recentes, como o de \textcite{weiss2020}, destacam sua importância na adaptação e evolução das práticas agrícolas, fornecendo informações repetitivas sobre o estado das culturas ao longo da temporada, em diferentes escalas e para diferentes partes interessada (\textit{stakeholders}). 
...
Há várias concepções propostas para sistemas embarcados, mas de forma geral ele pode ser definido como:
...
Na seção seguinte, serão abordados os microcontroladores e sua importância na implementação de soluções.
...
\begin{quote}
  "Um microprocessador (CPU), além de uma quantidade fixa de memória principal (RAM), memória de programa (ROM),  interfaces de entrada/saída (I/O) e um temporizador, todos em um único chip." \parencite{Mazid_microcontrolador2011}
\end{quote}
...
Neste trabalho em específico, o microcontrolador ESP32 foi escolhido devido à sua capacidade de comunicação \textit{wireless}. Há uma ampla gama de recursos disponíveis para o desenvolvimento de aplicações de IoT \parencite{ESP32_usage}, em especial para a gestão da irrigação.

A seguir, serão abordadas as características do ESP32 e sua importância na implementação de sistemas de monitoramento e controle.
...
O ESP32 pode ser programado usando o Arduino IDE e o ESP-IDF (Espressif IoT Development Framework), ambos baseados em C/C++. Através dessas plataformas de desenvolvimento (IDEs), os desenvolvedores podem acessar os recursos do ESP32 e criar uma variedade de aplicações. Esses projetos vão desde simples automação residencial até dispositivos complexos de monitoramento e controle \parencite{ferrandez2018precision, junior2022data, hsu2020creative}.
...
O presente trabalho se enquadra na categoria de CPS, pois integra componentes físicos, computacionais e de comunicação para monitorar e controlar um processo físico (a irrigação) de maneira automatizada e em tempo real. A infraestrutura necessária para conectar dispositivos físicos à internet e entre si é definida como IoT, como será abordado na próxima subseção. 
...
Atualmente, a IoT continua a evoluir rapidamente, com o surgimento de novas tecnologias como a computação em névoa (\textit{fog computing}) e a integração de IA \parencite{junior2022data}. Na agricultura, essa evolução tem sido especialmente significativa, com a IoT sendo empregada para melhorar a eficiência e a produtividade.
...
Contudo, por si só, o HTTP não é adequado para aplicações de IoT, devido à sua natureza orientada a texto e ao alto consumo de largura de banda \parencite{Yassein_mqtt2017}. Para esses casos, o protocolo MQTT é mais adequado, como será abordado na próxima subseção.
...
Essa mudança de práticas agrícolas tradicionais para agricultura inteligente, caracterizada pela integração de tecnologias emergentes como a IoT, análise de dados em grande escala (BDA), computação em nuvem e IA, tornou-se imperativa para atender às crescentes demandas por segurança alimentar em uma população global em rápido crescimento \parencite{Gurjeet_smart2022, Garg_smart2023}.
...
Segundo \textcite{Pierce_precision1999}, o sucesso da agricultura de precisão está relacionado à sua capacidade de avaliar, gerenciar e avaliar o continuum espaço-tempo na produção de culturas. Ela é habilitada pela tecnologia e integrada por tecnologias específicas que permitem avaliar e gerenciar a variabilidade em níveis de detalhe nunca antes alcançados \parencite{Zhang_precision2002}. No entanto, o sucesso agronômico da agricultura de precisão tem sido limitado e inconsistente, embora bastante convincente em alguns casos, complementa \textcite{Zhang_precision2002}.

Atualmente, de acordo com \textcite{Lamine_precision2024}, a agricultura de precisão é uma prática que envolve observar, medir e responder à variabilidade intra e entre campos. Ela busca tornar o processo de produção mais eficiente, considerando a conservação ambiental \parencite{Lamine_precision2024}. Apesar dos avanços tecnológicos e inovações, a agricultura de precisão ainda enfrenta desafios em países em desenvolvimento, especialmente em agricultura de pequena escala, conforme apontado por \textcite{Lamine_precision2024}. No entanto, existem amplas oportunidades e perspectivas para a adoção de inovações em agricultura de precisão \parencite{Lamine_precision2024}.
