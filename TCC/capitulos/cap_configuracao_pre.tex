...
Uma das áreas de aplicação do sensoriamento remoto na atualidade é a agricultura. Estudos recentes, como o de \textcite{weiss2020}, destacam sua importância na adaptação e evolução das práticas agrícolas, fornecendo informações repetitivas sobre o estado das culturas ao longo da temporada, em diferentes escalas e para diferentes partes interessadas (\textit{stakeholders}). 
